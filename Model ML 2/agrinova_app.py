...
PICKLE_FILE    = "agrinova_model_2.pkl"
...
class AgrinovaApp(tk.Tk):
    ...
    def _build_styles(self):
        ...
        style.map("Run.TButton",
                  background=[("active", "#000000"), ("disabled", "#AAB4CC")])
    ...
    def _build_ui(self):
        # ── Top banner ────────────────────────────────────────────────────────
        banner = tk.Frame(self, bg="#000000", height=54)
        banner.pack(fill="x")
        banner.pack_propagate(False)
        tk.Label(banner, text="🌱  AGRINOVA  —  Onion Spoilage Prediction Model 2",
                 bg="#000000", fg="white",
    ...
    def _on_tree_select(self, _event=None):
        ...
        lines += [
            ...
            f"WARNING  : Day {sp.get('warning', 'N/A')}",
            f"CRITICAL : Day {sp.get('critical', 'N/A')}",
            "",
            "Feature importances:",
        ]
